...
const KickBox = () => {
  ...
  return (
    <div className="max-w-[1112px] mx-auto pt-[140px] pb-[136px] max-xl:px-4 max-xl:py-28 max-lg:py-20 max-md:py-14">
      ...
      />
      <div className="flex gap-[97px] items-center justify-center max-lg:flex-col max-xl:gap-20 max-lg:gap-14 max-md:gap-10 max-xl:flex-wrap">
        <div
          ref={ref}
          className="flex gap-[52px] items-center w-full max-md:flex-wrap max-lg:gap-8 max-xl:justify-center"
        >
