  ...
  return (
    <div className="bg-hero-bg bg-cover bg-center bg-no-repeat min--screen relative">
      ...
      <Image
        ...
        alt="hero image"
      />
      <div className="flex items-start justify-center flex-col h-full pr-4 w-full pt-[197px] pl-[132px] pb-[168px] min-[1920.98px]:max-w-[1470px] min-[1920.98px]:mx-auto max-xl:pt-40 max-lg:pt-28 max-md:pt-24 max-xl:pl-20 max-lg:pl-5 max-lg:text-center max-lg:items-center max-lg:pb-24">
        <Description
